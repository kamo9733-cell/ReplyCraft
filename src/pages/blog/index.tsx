...
const BlogIndex = () => {
  React.useEffect(() => {
    document.title = "Blog | Reply Craft — ICP, Deliverability & Cold Outreach";
    const meta = document.querySelector('meta[name="description"]');
    if (meta)
      meta.setAttribute(
        "content",
        "Reply Craft blog: in-depth guides on ICPs, email warming, deliverability, and AI-driven outreach."
      );
  }, []);
